...
// 1️⃣ Klasörden hero görsellerini otomatik al
const heroImages = Object.values(
  import.meta.glob("../../images/hero_img/*.png", { eager: true, import: "default" })
) as string[];
    ...
    <section id="hero" className="relative min-h-screen bg-balkan-dark overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          animate={{ scale: 1, rotate: 360, x: 0, y: 0 }}
          transition={{
            duration: 2,
            ease: "easeOut",
        ...
        <motion.div
          ...
          animate={{ scale: 1, rotate: 90, x: 0, y: 0 }}
          transition={{
            duration: 2,
            delay: 0.3,
            ease: "easeOut",
            rotate: { repeat: Infinity, duration: 15, ease: "linear", delay: 0.3 }
          }}
        ...
        <motion.div
          ...
          transition={{
            ...
            delay: 0.6,
            ease: "easeOut",
            rotate: { repeat: Infinity, duration: 25, ease: "linear", delay: 0.6 }
          }}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          ...
          <motion.div
            ...
            className="relative w-full h-[calc(100vh-6rem)] mt-16 mb-8 overflow-hidden rounded-lg"
          >
            {heroImages.map((image, index) => (
              ...
              >
                <img
                  ...
                  className="w-full h-full object-contain bg-balkan-dark"
                />
                {/* Welcome badge → sol üstte */}
                {currentImageIndex === index && (
                  <motion.span
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                    className="absolute top-6 left-6 bg-balkan-yellow text-balkan-dark px-4 py-2 text-sm font-bold uppercase tracking-wider"
                  >
                    {t("hero.welcome")}
                  </motion.span>
                )}
          ...
          >
            <span className="text-sm uppercase tracking-wider">
              {t("hero.exploreMenu").replace("{{count}}", "")}
            </span>
            <motion.div
              animate={{ y: [0, 5, 0] }}
